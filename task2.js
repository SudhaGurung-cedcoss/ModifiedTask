...
function addData(){
 ...
 function push(arr){
    ...
    if(company.match(usercheck)){
      document.getElementById('nameError').innerHTML="";
    }
     else{
      document.getElementById('nameError').innerHTML="Invalid company name expression";
    ...
    number=/^[0-9]+$/;
    modelcheck=/^[A-Z a-z 0-9]+$/;
       
    if(memory.match(number)){
        document.getElementById('memoryError').innerHTML="";
      }
       else{
        document.getElementById('memoryError').innerHTML="Invalid company name expression";
        document.getElementById('memoryError').style.color="red";
        document.getElementById('memoryError').style.fontFamily="ubuntu";
        document.getElementById('memoryError').style.fontSize="8px";
        valid=false;
       }
  
       if(model.match(modelcheck)){
        document.getElementById('modelError').innerHTML="";
      }
       else{
        document.getElementById('modelError').innerHTML="Invalid company name expression";
        document.getElementById('modelError').style.color="red";
        document.getElementById('modelError').style.fontFamily="ubuntu";
        document.getElementById('modelError').style.fontSize="8px";
        valid=false;
       }
       ...
       if(price.match(number)){
        ...
        document.getElementById('priceError').innerHTML="Invalid company name expression";
        document.getElementById('priceError').style.color="red";
        document.getElementById('priceError').style.fontFamily="ubuntu";
        document.getElementById('priceError').style.fontSize="8px";
        valid=false;
       }
...
function maxAndMinRangeProduct(obj){
 ...
 function search(){
    ...
    else if(item=="Nokia")
    {
      ...
      alert("comapny name is not exist");
    }
